...
mass scale M03.\textbf{This is good, but it needs massaged into a
narrative.}
...
holes should be omitted.\textbf{The language here needs a bit of cleanup
and turned into more of a narrative. Try to stay away from subjective
language like ``really low'' and stick with quantitative measures.
How did you determine that 10\textasciicircum{}-20 is a silly value
for BH accretion?}
...
\label{sec:dis}\textbf{There is lots of great stuff in this section,
but it doesn't flow very well. Building a narrative is the hardest
part of writing a paper! }With the low accretion rate black holes
removed from the sample, we construct a power-law relationship between
$M$ and $\dot{M}$ using linear least-squares (Figure \ref{fig:bhpop_hist2d}).
